...
class TestIntEnumType(unittest.TestCase):
    ...
    def test__int_enum_type__arrowbic_class_supported(self):
    ...
    def test__int_enum_type__arrowbic_make_item_pyclass(self):
        ext_type = IntEnumType(pa.int64(), DummyIntEnum)
        metadata = ext_type.__arrowbic_ext_metadata__()
    ...
    def test__int_enum_type__arrowbic_from_item_iterator__input_list(self):
    ...
    def test__int_enum_type__arrowbic_from_item_iterator__input_iterator(self):
        values = [None, DummyIntEnum.Invalid, DummyIntEnum.Valid, None]
        arr = IntEnumType.__arrowbic_from_item_iterator__(iter(values))
