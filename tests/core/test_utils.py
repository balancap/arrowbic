...
def test__first_valid_item_in_iterable__list__proper_result():
...
def test__first_valid_item_in_iterable__iterator__proper_result():
    values = [None, 3, 2, None, 3]
...
def test__first_valid_item_in_iterable__none_iterator():
